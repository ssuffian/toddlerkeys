...
- 2026-09-13: A child escaped through a macOS Space swipe and Claude Quick Entry. The primary kiosk window is now pinned to all Spaces and actively reclaims focus; the documented physical setup disables OS-owned gestures, hot corners, and third-party global shortcuts that Electron cannot contain.
